  ...
  return (function (t) {
    ...
    112: function (t, e, s) {
      ...
      var r = s(40),
        i = s(39),
        n = s.n(i);
      const o = Phaser.Utils.Objects.GetValue,
        h = Phaser.Math.Distance.Between,
        u = Phaser.Math.Angle.Between;
      const a = { "up&down": 0, "left&right": 1, "4dir": 2, "8dir": 3 };
      var c = class extends r.a {
        ...
        resetFromJSON(t) {
          void 0 == this.start && (this.start = {}),
            ...
            this.setMode(o(t, "dir", "8dir")),
            this.setDistanceThreshold(o(t, "forceMin", 16));
          var e = o(t, "start.x", null),
            s = o(t, "start.y", null),
            r = o(t, "end.x", null),
            i = o(t, "end.y", null);
        ...
        setMode(t) {
          return "string" == typeof t && (t = a[t]), (this.dirMode = t), this;
        }
        setEnable(t) {
        ...
        setVector(t, e, s, r) {
          ...
          if (
            ...
            return this;
          var i = (this.angle + 360) % 360;
          switch (this.dirMode) {
            case 0:
              var n = i < 180 ? "down" : "up";
              this.setKeyState(n, !0);
              break;
            case 1:
              (n = i > 90 && i <= 270 ? "left" : "right"),
                this.setKeyState(n, !0);
              break;
            case 2:
              (n =
            ...
            case 3:
              i > 22.5 && i <= 67.5
                ? (this.setKeyState("down", !0), this.setKeyState("right", !0))
                : i > 67.5 && i <= 112.5
                ? this.setKeyState("down", !0)
                : i > 112.5 && i <= 157.5
                ? (this.setKeyState("down", !0), this.setKeyState("left", !0))
                : i > 157.5 && i <= 202.5
                ? this.setKeyState("left", !0)
                : i > 202.5 && i <= 247.5
                ? (this.setKeyState("left", !0), this.setKeyState("up", !0))
                : i > 247.5 && i <= 292.5
                ? this.setKeyState("up", !0)
                : i > 292.5 && i <= 337.5
                ? (this.setKeyState("up", !0), this.setKeyState("right", !0))
                : this.setKeyState("right", !0);
          }
          return this;
        }
        get forceX() {
        ...
        get force() {
          return h(this.start.x, this.start.y, this.end.x, this.end.y);
        }
        get rotation() {
      ...
      const d = Phaser.Events.EventEmitter,
        y = Phaser.Utils.Objects.GetValue,
        l = Phaser.Geom.Circle,
        b = Phaser.Geom.Circle.Contains;
      var p = class extends c {
        constructor(t, e) {
          super(e),
            ...
            t.setInteractive(
              new l(t.displayOriginX, t.displayOriginY, this.radius),
              b
            ),
            this.boot();
        }
